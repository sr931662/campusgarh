...
export default function ShareButtons({ url, title }) {
  ...
  return (
    <div className={styles.wrap}>
      ...
      <a className={`${styles.btn} ${styles.gmail}`} href={`https://mail.google.com/mail/?view=cm&fs=1&su=${t}&body=${u}`} target="_blank" rel="noopener noreferrer" title="Gmail"><SiGmail /></a>
      <a className={`${styles.btn} ${styles.outlook}`} href={`https://outlook.live.com/mail/0/deeplink/compose?subject=${t}&body=${u}`} target="_blank" rel="noopener noreferrer" title="Outlook"><FaEnvelope /></a>
