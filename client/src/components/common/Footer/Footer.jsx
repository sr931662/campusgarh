      ...
      <div className={styles.container}>
        ...
        {/* ── Copyright ── */}
          <div className={styles.copyright}>
            <p>© {currentYear} CampusGarh Pvt. Ltd. All rights reserved. Made with love by <a href="https://pinaqtech.com" target="_blank" rel="noopener noreferrer"><strong>Pinaqtech</strong></a></p>
